...
public class AdminSignup extends JFrame implements ActionListener {
    ...
    private final JFrame frame = new JFrame("Admin Sign up");
    private JTextField usernameField;
    private JPasswordField passwordField;
    private JButton signUpButton;
    private JButton exitButton;

    public AdminSignup(JFrame launchPageFrame, final UserService userService) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == exitButton) {
            ...
            if (created) {
                ...
                frame.dispose();
                AdminLogin window = new AdminLogin(launchPageFrame, this.userService);
            } else {
